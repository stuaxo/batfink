...
| `emulator/boot-6128.itest.ts` | (ROMs are committed) | CPC 6128 firmware boots to `Ready`; a BASIC 1.1 program runs |
| `emulator/banking-6128.itest.ts` | (ROMs are committed) | 128K RAM banking under the 6128 firmware — `CALL`ed from BASIC |
